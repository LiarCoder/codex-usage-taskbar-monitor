...
const RELEASE_ASSET_NAME: &str = "codex-usage-taskbar-monitor.exe";
...
const WINGET_PACKAGE_ID: &str = "LiarCoder.CodexUsageTaskbarMonitor";
...
mod tests {
    ...
    fn extracts_release_tag_from_github_latest_redirect() {
        assert_eq!(
            release_tag_from_latest_location(
                "https://github.com/LiarCoder/codex-usage-taskbar-monitor/releases/tag/v1.5.0"
            ),
            Some("v1.5.0")
        );
        assert_eq!(
            release_tag_from_latest_location(
                "/LiarCoder/codex-usage-taskbar-monitor/releases/tag/v1.5.0?expanded=true"
            ),
            Some("v1.5.0")
        );
        assert_eq!(
    ...
    fn builds_github_release_asset_url_from_tag() {
        assert_eq!(
            github_release_asset_url("LiarCoder", "codex-usage-taskbar-monitor", "v1.5.0"),
            "https://github.com/LiarCoder/codex-usage-taskbar-monitor/releases/download/v1.5.0/codex-usage-taskbar-monitor.exe"
        );
    }
}
