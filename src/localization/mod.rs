    ...
    pub fn from_code(code: &str) -> Option<Self> {
        ...
        match prefix {
            ...
            "zh" => {
                ...
                } else if normalized.contains("cn")
...
pub struct Strings {
    ...
    pub show_5hour_window: &'static str,
    pub show_7day_window: &'static str,
    ...
    pub codex_radar_menu: &'static str,
    pub enable_codex_radar: &'static str,
    pub refresh_codex_radar: &'static str,
    pub view_codex_radar_website: &'static str,
    pub codex_radar_consent_title: &'static str,
    ...
    pub radar_community_daily: &'static str,
    pub radar_daily_recommendation: &'static str,
    pub radar_hard_problem: &'static str,
